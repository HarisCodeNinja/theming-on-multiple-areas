import { createCourseOfferingPayloadValidator, updateCourseOfferingPayloadValidator } from './validation';
import { z } from 'zod';
...
export interface ICourseOfferingAdd extends z.infer<typeof createCourseOfferingPayloadValidator> {}
export interface ICourseOfferingEdit extends z.infer<typeof updateCourseOfferingPayloadValidator> {}
