...
const PaymentForm: React.FC<PaymentFormProps> = ({ }) => {
	const form = useFormContext<z.infer<typeof createPaymentPayloadValidator>>();
...
<FormField
                    ...
                    render={({ field: fieldProps }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <DatePicker value={fieldProps.value || undefined } onChange={fieldProps.onChange} placeholder="Select Payment Date" />
                            </FormControl>
